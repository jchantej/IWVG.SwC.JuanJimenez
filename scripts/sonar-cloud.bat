@echo off
set workspace=C:\Users\Chante\Documents\ProyectosEclipce\IWVG.SwC.JuanJimenez
...
call mvn sonar:sonar -Dsonar.organization=jchantej-github -Dsonar.host.url=https://sonarcloud.io -Dsonar.login=cc2e103d0d9b845d61aa89794b3e42247df14fb0 --settings settings.xml
pause
